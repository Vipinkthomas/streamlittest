# -*- coding: utf-8 -*-
"""
Created on Sat Apr 11 23:26:10 2020
...
#player_df.to_csv("updated_data.csv")
...
filtered_player_df= player_df[(player_df['Club'].isin(['FC Barcelona', 'Paris Saint-Germain',
       'Manchester United', 'Manchester City', 'Chelsea', 'Real Madrid','FC Porto','FC Bayern München'])) & (player_df['Nationality'].isin(['England', 'Brazil', 'Argentina',
       'Brazil', 'Italy','Spain','Germany','Portugal']))]
...
plt.show()
g=sns.pairplot(filtered_player_df[['Value','SprintSpeed','Wage','Potential','Nationality']],hue='Nationality')
#g=sns.pairplot(filtered_player_df,x_vars=["Value","Wage"],y_vars=["SprintSpeed","Potential",'Nationality'],hue='Nationality')
#Swarmplots
...
max_wage_player=filtered_player_df[filtered_player_df['Wage']==max_wage]['Name'].values[0]
g=sns.boxplot(y='Club',x='Wage',data=filtered_player_df,whis=np.inf)
g=sns.swarmplot(y='Club',x='Wage',data=filtered_player_df,size=7,color='black')
sns.despine()
plt.annotate(s=max_wage_player,xy=(max_wage,0),xytext=(max_wage-50,1),arrowprops={'facecolor':'gray','width':3,'shrink':0.01})
g.figure.set_size_inches(14,10)
plt.show()
